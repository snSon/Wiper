...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|GPIO_PIN_12|GPIO_PIN_14, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PC13 PC4 PC6 */
  GPIO_InitStruct.Pin = GPIO_PIN_13|GPIO_PIN_4|GPIO_PIN_6;
  ...
  /*Configure GPIO pins : PB0 PB12 PB14 */
