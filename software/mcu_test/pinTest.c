...
GPIO_TypeDef* GPIO_PORT[] = {
  GPIOA, GPIOA, GPIOA, GPIOB, GPIOB, GPIOB, GPIOB, GPIOA, GPIOA, GPIOC
};
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2|GPIO_PIN_3|LD2_Pin|GPIO_PIN_8
  ...
  /*Configure GPIO pins : PA2 PA3 LD2_Pin PA8
                           PA9 PA10 PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_3|LD2_Pin|GPIO_PIN_8
